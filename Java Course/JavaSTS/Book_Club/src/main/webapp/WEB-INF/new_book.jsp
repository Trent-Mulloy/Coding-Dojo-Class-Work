...
<body class="container text-center" id="main">
    ...
    <form:form action="/create/book" method="post" class="container text-center" id="Form" modelAttribute="newBook">
    ...
    <div class="form-group m-3">
        <form:label path="author" for="author">Author (Last Name, First Name):</form:label>
